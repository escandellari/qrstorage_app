...
function getBasePageModel(box, options = {}) {
  return {
    ...
    itemValues: options.itemValues ?? {},
    itemErrors: options.itemErrors ?? {},
    editItemId: options.editItemId ?? '',
    editItemValues: options.editItemValues ?? {},
    editItemErrors: options.editItemErrors ?? {},
    editOriginalItemValues: options.editOriginalItemValues ?? {},
    conflictItemId: options.conflictItemId ?? '',
    conflictItem: options.conflictItem ?? null,
    removedItemMessage: options.removedItemMessage ?? '',
