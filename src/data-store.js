    ...
    async duplicateBox(boxId) {
      return withMutationLock(async () => {
        ...
        const duplicatedBox = {
          ...
          boxCode: getNextBoxCode(data.boxes),
          name: sourceBox.name,
          locationMode: sourceBox.locationMode,
          simpleLocation: sourceBox.simpleLocation,
          structuredLocation: sourceBox.structuredLocation ? { ...sourceBox.structuredLocation } : sourceBox.structuredLocation,
